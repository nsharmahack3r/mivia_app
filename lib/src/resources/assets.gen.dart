...
class $AssetsAnimationsGen {
  ...
  /// File path: assets/animations/bike.json
  LottieGenImage get bike =>
      const LottieGenImage('assets/animations/bike.json');

  /// File path: assets/animations/car.json
  LottieGenImage get car => const LottieGenImage('assets/animations/car.json');

  /// List of all assets
  List<LottieGenImage> get values => [bike, car];
}
